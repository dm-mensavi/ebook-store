    ...
    <div className="">
      ...
      <section className="flex flex-col-reverse md:flex-row items-center justify-between bg-white py-4 px-6 md:px-8">
        ...
        <div className="relative mt-12 md:mt-0 w-72 h-72 md:w-[30rem] md:h-[30rem] flex justify-center items-center">
          ...
          {/* Top Left (Green - Brain) */}
          <div className="absolute top-4 left-20 bg-green-100 p-3 rounded-full shadow-md animate-float">
            <Brain className="text-green-600 w-6 h-6" />
          </div>

          {/* Top Right (Purple - BadgeCheck) */}
          <div className="absolute top-20 right-10 bg-purple-100 p-3 rounded-full shadow-md animate-float-slow">
            <BadgeCheck className="text-purple-600 w-6 h-6" />
          </div>

          {/* Left Middle (Orange - Target) */}
          <div className="absolute left-16 bottom-1/3 transform translate-y-1/2 bg-orange-100 p-3 rounded-full shadow-md animate-float-delay">
            <Target className="text-orange-600 w-6 h-6" />
          </div>

          {/* Bottom Right (Blue - BookOpen) */}
          <div className="absolute bottom-10 right-4 bg-blue-100 p-3 rounded-full shadow-md animate-float">
            <BookOpen className="text-blue-600 w-6 h-6" />
          </div>
        </div>
      </section>
